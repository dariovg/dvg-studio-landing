...
<body style="margin:0;padding:0;background:#F5F7FA;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" class="email-outer-pad" style="background:#F5F7FA;padding:32px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 8px 32px rgba(10,14,39,.08);">
        <tr><td class="email-header-pad" style="padding:28px 28px 12px;text-align:center;background:linear-gradient(180deg,#0A0E27 0%,#121830 100%);">
          <img class="email-logo" src="${logo}" width="220" alt="DVG Studio" style="max-width:220px;height:auto;display:block;margin:0 auto 10px;">
        ...
        <tr><td class="email-inner-pad" style="padding:28px;color:#1a2332;font-size:15px;line-height:1.6;">
