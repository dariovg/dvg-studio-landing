...
export function buildCustomerConfirmationEmail(booking) {
  const meet = meetUrl();
  const gcal = googleCalendarAddUrl(booking);
  const logo = `${SITE_URL}/assets/logo-dvg-studio.png`;
