...
export function buildPricingGuideEmail(lead) {
  ...
  const text = [
    ...
    "",
    "STARTER — 349 €/mes",
    "· 1 agente IA · todos los canales (WA, TG, email, web…)",
    "· Auditoría gratis · soporte 24/7 y mejoras continuas",
    "",
    "PRO — 949 €/mes (el más elegido)",
    "· Hasta 5 agentes IA · todos los canales",
    "· Integración con tu CRM/herramientas · mejoras web con IA",
    "· Auditoría gratis · soporte 24/7",
    "",
    "ENTERPRISE — 1.749 €/mes",
    "· Hasta 10 agentes IA a medida · todos los canales",
    ...
    "",
    "Implementación inicial: presupuesto aparte tras auditoría (integraciones y puesta en marcha).",
    "Anual -20%: Starter 279 € · Pro 759 € · Enterprise 1.399 €/mes (+ IVA)",
    "",
    TIMELINES,
    "",
        ...
        <tr><td style="padding:28px;color:#1a2332;font-size:15px;line-height:1.6;">
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;color:#333;line-height:1.55;">
            <tr><td style="padding:12px 14px;background:#f8f9fc;border-radius:10px 10px 0 0;border:1px solid #eee;border-bottom:none;">
              <strong style="color:#FF6B35;">Starter</strong> — 349 €/mes<br>
              <span style="color:#666;">1 agente IA · todos los canales · auditoría gratis · 24/7</span>
            </td></tr>
            <tr><td style="padding:12px 14px;background:#fff5f0;border-left:3px solid #FF6B35;border-right:1px solid #eee;">
              <strong style="color:#FF6B35;">Pro ★</strong> — 949 €/mes<br>
              <span style="color:#666;">Hasta 5 agentes · todos los canales · integración CRM/herramientas · 24/7</span>
            </td></tr>
            <tr><td style="padding:12px 14px;background:#f8f9fc;border:1px solid #eee;border-top:none;">
              <strong style="color:#FF6B35;">Enterprise</strong> — 1.749 €/mes<br>
              <span style="color:#666;">Hasta 10 agentes · todos los canales · CRM/ERP · account manager + SLA</span>
            </td></tr>
