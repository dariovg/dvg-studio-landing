  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#F5F7FA;padding:28px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:580px;background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 12px 40px rgba(10,14,39,.1);">
        <tr><td style="padding:32px 28px 16px;text-align:center;background:linear-gradient(180deg,#0A0E27 0%,#121830 100%);">
          <img src="${logo}" width="200" alt="DVG Studio" style="max-width:200px;height:auto;display:block;margin:0 auto 12px;">
        ...
        <tr><td style="padding:28px 24px;color:#1a2332;font-size:15px;line-height:1.6;">
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 20px;">
            <tr><td style="font-size:13px;color:#444;background:#f8f9fc;padding:14px 16px;border-radius:12px;border:1px solid #e8ecf2;">
              ✓ Auditoría <strong>gratuita</strong> &nbsp;·&nbsp; Mín. <strong>3 meses</strong> &nbsp;·&nbsp; Todos los canales &nbsp;·&nbsp; Soporte <strong>24/7</strong>
            </td></tr>
          </table>
          ${howWeWorkInfographicHtml()}
          ${pricingPlansInfographicHtml()}
          ...
          <p style="text-align:center;margin:0;">
            <a href="${SITE_URL}#pricing" style="display:inline-block;background:linear-gradient(135deg,#FF6B35 0%,#e85a28 100%);color:#fff;text-decoration:none;padding:14px 28px;border-radius:999px;font-weight:800;font-size:15px;box-shadow:0 6px 20px rgba(255,107,53,.3);">Ver planes y reservar auditoría</a>
          </p>
          ${emailFooterHtml()}
        </td></tr>
      </table>
