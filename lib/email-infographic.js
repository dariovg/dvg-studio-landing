...
export function howWeWorkInfographicHtml() {
  const steps = [
    { n: "1", title: "Auditoría", desc: "Entendemos tu negocio y dónde pierdes tiempo" },
    { n: "2", title: "Agente IA", desc: "Diseñamos un empleado digital a tu medida" },
    { n: "3", title: "Canales", desc: "Web, WhatsApp, email… donde estén tus clientes" },
    { n: "4", title: "24/7", desc: "Atiende, cualifica y agenda sin parar" },
  ];
...
export function howWeWorkInfographicText() {
  return [
    "Cómo trabajamos:",
    "1. Auditoría — conocemos tu negocio",
    "2. Agente IA — empleado digital a medida",
    "3. Canales — web, WhatsApp, email…",
    "4. 24/7 — atiende y agenda sin parar",
  ].join("\n");
}
