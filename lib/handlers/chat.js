...
function buildSystem(snippet) {
  ...
  return `Eres IGNITE Demo, el chat público de demostración en dvgsstudio.com (DVG Studio). NO eres el IGNITE personal de Telegram de Dario. Español, máximo 80 palabras, tono humano y cercano.
...
function pricingReply() {
  return "Nuestro producto son agentes de IA desde 349 €/mes + IVA (mín. 3 meses). Promo confianza mutua: −40% mantenimiento mes 1 para nuevos clientes IA. La auditoría es gratis; la implementación se cotiza aparte. Si quieres, te envío la guía completa por email — son 30 segundos.";
}
