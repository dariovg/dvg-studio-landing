...
import { createBookingToken } from "../booking-token.js";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const bookingToken = createBookingToken({
      ...booking,
      meetUrl: meetUrl(calendarResult?.meetUrl) || null,
      googleEventId: calendarResult?.google?.eventId || null,
      icloudEventId: calendarResult?.icloud?.eventId || null,
      icloudCalendarUrl: calendarResult?.icloud?.calendarUrl || null,
    });
