...
import { calendarConfigured } from "../google-calendar.js";
...
export default async function handler(req, res) {
  ...
  const readyForLeads = checks.awsCredentials && checks.sesFromEmail;
  ...
  if (!checks.meetUrl) {
    hints.push("Añade BOOKING_MEET_URL con tu enlace permanente de Google Meet.");
  }
  ...
  if (!expected) {
    hints.push("Opcional: define DIAGNOSTIC_KEY en Vercel para proteger este endpoint.");
  }
