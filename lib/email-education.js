...
export function agentEducationInfographicHtml() {
    ...
    <td width="50%" style="padding:0;vertical-align:top;">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:${highlight ? "#fff8f3" : "#f8f9fc"};${highlight ? "border-left:3px solid #FF6B35;" : "border-right:1px solid #e8ecf2;"}">
        <tr><td style="padding:18px 16px;">
          <p style="margin:0 0 10px;font-size:12px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;color:${color};">${icon} ${title}</p>
          ${items
            .map(
              (item) =>
  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:20px 0 0;border-radius:16px;overflow:hidden;border:1px solid #e8ecf2;box-shadow:0 4px 24px rgba(10,14,39,.06);">
    <tr><td style="padding:20px;text-align:center;background:linear-gradient(135deg,#0A0E27 0%,#1a2340 100%);">
      ...
      <p style="margin:8px 0 0;font-size:12px;color:#aab4c8;">Lo que contratas en DVG Studio es un agente, no un chat genérico</p>
    </td></tr>
    <tr>
      ${row(
        "💬",
    ...
    <tr><td colspan="2" style="padding:20px;background:#fff;text-align:center;border-top:1px solid #eee;">
      ...
      <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 auto;">
        <tr>
          <td style="padding-right:18px;vertical-align:middle;">
            <img src="${qr}" width="96" height="96" alt="QR encuesta" style="display:block;border-radius:12px;border:2px solid #f0f0f0;box-shadow:0 4px 12px rgba(0,0,0,.08);">
          </td>
          <td style="vertical-align:middle;text-align:left;">
            <a href="${link}" style="display:inline-block;background:linear-gradient(135deg,#FF6B35 0%,#e85a28 100%);color:#fff;text-decoration:none;padding:14px 24px;border-radius:999px;font-weight:800;font-size:14px;box-shadow:0 4px 14px rgba(255,107,53,.35);">Rellenar encuesta</a>
            <p style="margin:10px 0 0;font-size:10px;color:#999;word-break:break-all;max-width:180px;">${link.replace(/^https:\/\//, "")}</p>
          </td>
        </tr>
      </table>
    </td></tr>
    <tr><td colspan="2" style="padding:18px 20px;background:linear-gradient(180deg,#0A0E27 0%,#121830 100%);text-align:center;">
      <img src="${logoUrl()}" width="150" alt="DVG Studio" style="display:block;margin:0 auto 8px;max-width:150px;height:auto;">
