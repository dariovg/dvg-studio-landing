...
export function syncBookingCancelToCrm(payload) {
  return syncToCrm("booking/cancel", payload);
}

export function syncBookingUpdateToCrm(booking) {
  return syncToCrm("booking/update", booking);
}
