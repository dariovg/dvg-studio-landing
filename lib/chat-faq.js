...
const FAQ = [
  ...
  },
  {
    ...
    reply:
      "Tenemos planes desde 349 €/mes + IVA (mantenimiento y soporte). La implementación se cotiza aparte. Te envío la guía por email si rellenas el formulario — sin compromiso.",
  },
  {
  ...
  },
  {
    ...
    reply: `Facturación anual con -${ANNUAL_DISCOUNT_PERCENT}% sobre el fee mensual. Te lo detallo en la guía por email — indícame abajo tu correo.`,
  },
  {
